...
<!-- AUTO:STATE -->
<!-- Généré automatiquement par scripts/v9_sync_state.py — 2026-07-14 21:45 UTC -->
<!-- Ne pas éditer manuellement. Pour forcer : python scripts/v9_sync_state.py -->

| Métrique | Valeur | Source |
|---|---|---|
| HEAD | `d801518 docs(v9): ROADMAP complete — phases livrées + prochaines actions + timeline` | `git log --oneline -1` |
| Tests collectés | 1335 | `pytest --collect-only` |
| Tables DB | 19 | `sqlite3 data/v9_forces.db` |
| Index DB | 49 | `sqlite3` |
| Taille DB | 1.38 GB | `du -h` |
| Décisions | 64315 | `SELECT count(*) FROM decisions` |
| Forces snapshots | 113994 | DB |
| Scènes | 64333 | DB |
| Principle evals | 578954 | DB |
| Régime snapshots | 514528 | DB |
| Paper trades | 0 | DB |
