"""Test unitaire — les 27 principes s'évaluent sans KeyError avec un contexte
complet (scène/comportement/fenêtre/exploitabilité/régime/zone présents),
Phase C2 doctrine realign."""
