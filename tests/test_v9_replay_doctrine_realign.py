...
def test_pre_patch_active_ids_is_10_post_is_10_c1_rejected():
    ...
    assert len(replay.POST_PATCH_ACTIVE_IDS) == 10
    assert replay.PRE_PATCH_ACTIVE_IDS == replay.POST_PATCH_ACTIVE_IDS
