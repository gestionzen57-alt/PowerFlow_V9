...
def test_pre_patch_active_ids_is_10_post_is_27():
    assert len(replay.PRE_PATCH_ACTIVE_IDS) == 10
    assert len(replay.POST_PATCH_ACTIVE_IDS) == 27
    assert replay.PRE_PATCH_ACTIVE_IDS.issubset(replay.POST_PATCH_ACTIVE_IDS)
