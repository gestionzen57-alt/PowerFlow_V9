...
def test_catalogue_shrinks_from_28_to_27():
    """28 -> 25 depuis archivage GRAMMAR_GRAVITE/GRAMMAR_INVERSION (Phase 9.8 B5).
    ...
    # Analyse comportementale 2026-07-22 : +GRAMMAR_CROISEMENT_CONFIRMATION → 55.
