...
- Décisions filtrées (calibrated_proba ≥ 0.85) : **6698**
...
|---|---:|---:|---:|
| **Win Rate** | 84.0725% | 91.4751% | **+7.40 pts** |
| **Trades** | 8771 | 6698 | -2073 |
| **Pips cumulés** | +46628.6 | +44449.3 | -2179.3 |
| **Avg pips/trade** | +5.316 | +6.636 | +1.320 |
| **Profit Factor** | 4.894 | 7.185 | **+2.291** |
...
> **⚠️ MARGINAL — uplift positif mais sous cible. À itérer.**
