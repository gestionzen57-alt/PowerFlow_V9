...
| Décision | Signal + contexte complet + action recommandée (Phase 9) | [LEXICON_V9.md](lexicon/LEXICON_V9.md#décision) |
...
| Principe | Règle de trading évaluable (entrée → bool + confiance) — un détecteur, pas un signal (Phase 9) | [LEXICON_V9.md](lexicon/LEXICON_V9.md#principe) |
| Régime | État global du marché (trend, range, breakout, compression) (Phase 9) | [LEXICON_V9.md](lexicon/LEXICON_V9.md#régime) |
...
## Termes de Phase 9 (canonisés le 2026-07-05)

Ces termes correspondent au code de la Phase 9, clôturée et revérifiée contre le code réel
(214 tests, tous verts) à la date ci-dessus — voir
[docs/phases/PHASE9_DECISION.md](phases/PHASE9_DECISION.md). Seule « Zone extrême » reste
marquée comme non alimentée (`zone_diagnostics` créée mais sans détecteur, gap connu non
bloquant) : les principes qui en dépendent se dégradent gracieusement, jamais en erreur.
