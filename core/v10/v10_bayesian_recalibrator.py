...
# Defaults R6 fail-open — valeurs grid-search (compat tests). apply_thresholds_c9
# a ses propres fallbacks C9 hardcodés (45/20/1), donc ce dict sert au chemin legacy.
DEFAULT_THRESHOLDS = {
...
# ============ CYCLE 9-10 ADDITIF - classes retro-compatibles (R2) ============
...
__all__ = [
    ...
    # C9 additif (retro-compatible)
    "BayesianPrior",
    "RecalibratorResult",
    "BayesianRecalibrator",
    "apply_thresholds_c9",
    "_get_ctx_min_for_session",
]