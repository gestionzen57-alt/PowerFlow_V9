# CLAUDE.md — PowerFlow V9 (mémoire workspace Hermes / Claude Code)

> **Source de vérité** : `AGENT.md` (document racine). Ce fichier est un pointeur
> pour Hermes — il référence la mémoire du projet et les conventions de travail.
...
| Document | Rôle | Quand |
|---|---|---|
| `AGENT.md` | État système auto-généré + mission + routing | Démarrage |
| `docs/STATE.md` | État vivant par phase | Démarrage |
...
python scripts/agent_bus_cli.py poll <profile> --source hermes
